...
$query = "DELETE FROM note WHERE page_id='".$page_id."' AND note_id = '$note_id' AND user_id = '".$$member_key."' ";
$result = fn_query($conn_id,$query);
disconnect($conn_id);
header("location:note.php?page_id=$page_id&category=$category"); exit;
?>